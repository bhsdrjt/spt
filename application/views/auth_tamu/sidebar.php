        ...
        <div class="sidebar-inner px-4 pt-3">
            <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="<?= base_url() ?>assets/img/favicon/logo.png" class="card-img-top rounded-circle border-white" alt="Tamu">
                    </div>
                    <div class="d-block">
                        <h2 class="h5 mb-3">Tamu</h2>
                        <a href="<?= base_url('Auth') ?>" class="btn btn-outline-danger btn-sm d-inline-flex align-items-center">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item active">
                    <a href="<?= base_url('Auth_tamu') ?>" class="nav-link">
